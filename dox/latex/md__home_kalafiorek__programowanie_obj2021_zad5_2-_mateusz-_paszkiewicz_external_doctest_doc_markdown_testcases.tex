...
Other than the additional prefixes and the formatting in the console reporter these macros behave exactly as {\ttfamily T\+E\+S\+T\+\_\+\+C\+A\+SE}s and {\ttfamily S\+U\+B\+C\+A\+SE}s. As such there is nothing enforcing the correct sequencing of these macros -\/ that\textquotesingle{}s up to the programmer!\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_testcases_autotoc_md146}{}\doxysection{Test fixtures}\label{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_testcases_autotoc_md146}
