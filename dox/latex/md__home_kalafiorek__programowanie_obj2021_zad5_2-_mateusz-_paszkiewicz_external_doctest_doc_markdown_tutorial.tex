...
\href{https://en.wikipedia.org/wiki/Test-driven_development}{\texttt{ T\+DD}} is not discussed in this tutorial.\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_tutorial_autotoc_md152}{}\doxysection{A simple example}\label{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_tutorial_autotoc_md152}
...
Of course there are still more issues to do deal with. For example we\textquotesingle{}ll hit problems when the return value starts to exceed the range of an int. With factorials that can happen quite quickly. You might want to add tests for such cases and decide how to handle them. We\textquotesingle{}ll stop short of doing that here.\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_tutorial_autotoc_md153}{}\doxysection{What did we do here?}\label{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_tutorial_autotoc_md153}
...
\end{DoxyEnumerate}\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_tutorial_autotoc_md154}{}\doxysection{Test cases and subcases}\label{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_tutorial_autotoc_md154}
...
In fact it is usually a good idea to put the block with the {\ttfamily \#define} in it\textquotesingle{}s own source file.\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_tutorial_autotoc_md156}{}\doxysection{Next steps}\label{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_tutorial_autotoc_md156}
