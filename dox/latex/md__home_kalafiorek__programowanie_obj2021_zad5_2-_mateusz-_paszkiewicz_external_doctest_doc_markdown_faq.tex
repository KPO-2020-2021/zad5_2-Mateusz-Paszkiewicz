...
\end{DoxyCode}
\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md96}{}\doxysubsection{How is $<$strong$>$doctest$<$/strong$>$ different from Google Test?}\label{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md96}
...
The areas where doctest is behind are planned for improvement in the future. There are many other smaller differences -\/ it would be impractical to cover them all.\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md97}{}\doxysubsection{How to get the best compile-\/time performance with the framework?}\label{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md97}
...
These 2 things can be considered negligible and totally worth it if you are dealing mainly with expressions unlikely to throw exceptions and all the tests usually pass (you don\textquotesingle{}t need to navigate often to a failing assert with a debugger attached).\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md98}{}\doxysubsection{Is doctest thread-\/aware?}\label{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md98}
...
There is also an option to run a $\ast$$\ast$range$\ast$$\ast$ of tests from an executable -\/ so tests can be ran in parallel by invoking the process multiple times with different ranges -\/ see \href{../../examples/range_based_execution.py}{\texttt{ {\bfseries{the example python script}}}}.\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md99}{}\doxysubsection{Is mocking supported?}\label{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md99}
...
by using the \href{logging.md\#messages-which-can-optionally-fail-test-cases}{\texttt{ {\bfseries{logging}}}} macros such as {\ttfamily A\+D\+D\+\_\+\+F\+A\+I\+L\+\_\+\+A\+T(file, line, message)}\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md100}{}\doxysubsection{Why are my tests in a static library not getting registered?}\label{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md100}
...
Also note that it would be a good idea to add a tag in your test case names (like this\+: {\ttfamily T\+E\+S\+T\+\_\+\+C\+A\+SE(\char`\"{}\mbox{[}the\+\_\+lib\mbox{]} testing foo\char`\"{})}) so the user can easily filter them out with {\ttfamily -\/-\/test-\/case-\/exclude=$\ast$the\+\_\+lib$\ast$} if he wishes to.\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md103}{}\doxysubsection{Does the framework use exceptions?}\label{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md103}
Yes -\/ but they can be disabled -\/ see the \href{configuration.md\#doctest_config_no_exceptions}{\texttt{ $\ast$$\ast${\ttfamily D\+O\+C\+T\+E\+S\+T\+\_\+\+C\+O\+N\+F\+I\+G\+\_\+\+N\+O\+\_\+\+E\+X\+C\+E\+P\+T\+I\+O\+NS}$\ast$$\ast$}} config identifier.\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md104}{}\doxysubsection{Why do I get compiler errors in S\+T\+L headers when including the doctest header?}\label{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md104}
Try using the \href{configuration.md\#doctest_config_use_std_headers}{\texttt{ $\ast$$\ast${\ttfamily D\+O\+C\+T\+E\+S\+T\+\_\+\+C\+O\+N\+F\+I\+G\+\_\+\+U\+S\+E\+\_\+\+S\+T\+D\+\_\+\+H\+E\+A\+D\+E\+RS}$\ast$$\ast$}} configuration identifier.\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md105}{}\doxysubsection{Can different versions of the framework be used within the same binary (executable/dll)?}\label{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md105}
Currently no. Single header libraries like \href{https://github.com/nothings/stb}{\texttt{ {\bfseries{stb}}}} have this as an option (everything gets declared static -\/ making it with internal linkage) but it isn\textquotesingle{}t very logical for {\bfseries{doctest}} -\/ the main point is to write tests in any source file of the project and have the test runner implemented in only one source file.\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md106}{}\doxysubsection{Why is doctest using macros?}\label{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_faq_autotoc_md106}
