...
Currently $\ast$$\ast$logging macros$\ast$$\ast$ cannot be used for extra context for asserts outside of a test run. That means that the {\ttfamily \+\_\+\+M\+E\+S\+S\+A\+GE} variants of asserts are also not usable -\/ since they are just a packed {\ttfamily I\+N\+F\+O()} with an assert right after it.\hypertarget{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_assertions_autotoc_md45}{}\doxysection{Floating point comparisons}\label{md__home_kalafiorek__programowanie_obj2021_zad5_2-_mateusz-_paszkiewicz_external_doctest_doc_markdown_assertions_autotoc_md45}
